...
console.log('  5. npm run build:apk:client  — ou build:apk:gerant / livreur / … (binaire natif)');
console.log('  6. npm run eas:update:*      — OTA JS seulement après un build avec les bons secrets');
...
console.log('  npm run build:apk:client       — APK client (exemple)');
console.log('  npm run eas:update:client      — OTA JS après build avec bons secrets');
console.log('');
process.exit(0);
